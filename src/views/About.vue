  ...
  <div>
    ...
    <section class="bg-white">
      <nav class="p-5">
        <div class="container m-auto pt-5 flex justify-between items-center">
          <div class="flex justify-center items-center gap-3">
            <router-link to="/" class="hidden md:block backdrop:text-xl">Noel Xavier</router-link>
      ...
      <div class="container mx-auto">
        <img src="../assets/img/profile.jpg" alt="" class="h-[200px] rounded-full mx-auto" srcset="">
        <h3 class="text-4xl xl:text-6xl text-center">About Me</h3>
        <h5 class="text-3xl mt-5 italic">"To enable myself in an environment where I can unlock my potential in the IT industry, learn and continue to enhance my skills as I build for my future career while contributing to the success of the organization."</h5>
        <br>
        <br>
        <p class="text-2xl">I started learning programming during my Senior High School days at STI College Baguio. Java was may the first programming language that I learned. It was also on my Senior High School days where web fundamentals like HTML and CSS was introduced to me. It was on college days where I leared PHP and flutter for mobile development. I finished my 300-hour On-The-Job-Training at PC4Me One Stop Computer Corporation as a Junior Web Developer</p>
        <br>
        <p class="text-2xl">On my free time, I like to binge-watch korean dramas, professional esports games and loves to collection random vintage things especially clothing. I have an instagram shop name <a href="https://www.instagram.com/99th.chronicles/" target="_blank" class="text-blue-300 underline">99th.chronicles</a>.</p>
      </div>
    </section>

    <section>
      <div class="container mx-auto">
        <h3 class="text-6xl text-center my-5">Awards and Certificates</h3>
        <div class="grid grid-cols-3 gap-5">
          <div class="bg-gray-50 shadow-md rounded-md p-4">
            <img src="../assets/img/certs/codefest-cluster.jpeg" alt="">
          </div>
          <div class="bg-gray-50 shadow-md rounded-md p-4">
            <img src="../assets/img/certs/codefest-nationals.jpeg" alt="">
          </div>
          <div class="bg-gray-50 shadow-md rounded-md p-4">
            <img src="../assets/img/certs/c-prog.jpeg" alt="">
          </div>
          <div class="bg-gray-50 shadow-md rounded-md p-4">
            <img src="../assets/img/certs/pao.jpeg" alt="">
          </div>
          <div class="bg-gray-50 shadow-md rounded-md p-4">
            <img src="../assets/img/certs/python.jpeg" alt="">
          </div>
          <div class="bg-gray-50 shadow-md rounded-md p-4">
            <img src="../assets/img/certs/startup.jpeg" alt="">
          </div>
           <div class="bg-gray-50 shadow-md rounded-md p-4">
            <img src="../assets/img/certs/technofest.jpeg" alt="">
          </div>
           <div class="bg-gray-50 shadow-md rounded-md p-4">
             <img src="../assets/img/certs/technofest-2.png" alt="">
          </div>
        </div>
      </div>
    </section>
